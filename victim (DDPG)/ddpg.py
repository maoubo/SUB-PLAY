...
class DDPG(object):
    ...
    def save_model(self, save_dir, agent, seed, version):
        torch.save(self.actor.state_dict(), "{}/actor_{}_seed_{}_version_{}.pth"
                   .format(save_dir, agent, seed, version))
    ...
    def load_model(self, load_dir, agent, seed, version):
        self.actor.load_state_dict(
            torch.load("{}/actor_{}_seed_{}_version_{}.pth".format(load_dir, agent, seed, version)))
